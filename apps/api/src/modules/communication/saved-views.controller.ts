...
export class SavedViewsController {
  ...
  save(@Req() request: BertRequest, @Body() body: { module: string; name: string; queryState: Record<string, unknown>; isDefault?: boolean }) {
    ...
    if (!module || !['TASKS', 'REQUESTS', 'DOCUMENTS', 'EMPLOYEES', 'FEED'].includes(module) || !name || name.length > 80 || !body.queryState || typeof body.queryState !== 'object' || Array.isArray(body.queryState)) throw badRequest('saved_view_fields')
