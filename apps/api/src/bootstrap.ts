...
export function configureApp(app: INestApplication): void {
  ...
  const swagger = new DocumentBuilder().setTitle('BERT CRM API').setDescription('BERT CRM modular monolith API').setVersion('1.0.0').addCookieAuth(config.SESSION_COOKIE_NAME).build()
