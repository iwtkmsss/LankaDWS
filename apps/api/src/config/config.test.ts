...
describe('production configuration', () => {
  ...
  it('accepts independent strong secrets and a real scanner', () => {
    ...
    vi.stubEnv('FILE_STORAGE_DIR', 'D:/bert-data/files')
    vi.stubEnv('FILE_QUARANTINE_DIR', 'D:/bert-data/quarantine')
    vi.stubEnv('FILE_TEMP_DIR', 'D:/bert-data/tmp')
    vi.stubEnv('BACKUP_DIR', 'E:/bert-backups')
