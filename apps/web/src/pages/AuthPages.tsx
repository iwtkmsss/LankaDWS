...
export function LoginPage() {
  ...
  return <main className="auth-page">
    <section className="auth-panel"><div className="auth-brand"><BrandMark /><strong>BERT CRM</strong></div><div className="auth-copy"><span className="eyebrow">Внутрішній простір команди</span><h2>Робота, рішення й знання — в одному місці.</h2></div><img src="/assets/auth/editorial-workspace.png" alt="Світлий сучасний робочий простір BERT" width="720" height="480" /></section>
    <section className="login-card"><div><span className="eyebrow">З поверненням</span><h1>Увійти до BERT CRM</h1></div>
